              ...
              children: [
                ...
                orderSummaryCard(
                    info: orderSummaryInfo(
                        ordersCount: 8, title: "All Orders", percentage: 100)),
                const SizedBox(
                  height: 20,
                  width: 27,
                ),
               ...
               const Padding(
                ...
                SizedBox(
                  ...
                  child: CustomDropdown<String>(
                    ...
                    list: ["All Orders", "Pending", "Processed", "Shipped","Cancelled","Delivered"],
                    onchanged: (newValue) {
                      if (newValue==null) {
                        return;
                      }
                      context.read<DataProvider>().filterOrdersByStatus(newValue);
                    },
                    validator: (value) {
                      if (value == null) {
