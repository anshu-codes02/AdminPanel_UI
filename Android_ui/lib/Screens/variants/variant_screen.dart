...
import 'package:adminpanel/Screens/variants/components/variant_add.dart';
import 'package:adminpanel/Screens/variants/components/variant_list.dart';
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                         ...
                         children: [
                          const Text("Variants",style: TextStyle(fontSize: 33,fontWeight: FontWeight.w700,color: Colors.black54),
                    ),
                    AddButton(context),
