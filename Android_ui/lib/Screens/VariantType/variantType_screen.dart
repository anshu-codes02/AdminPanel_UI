...
import 'package:adminpanel/Screens/VariantType/components/variantType_add.dart';
import 'package:adminpanel/Screens/VariantType/components/variantType_list.dart';
import 'package:flutter/material.dart';

class VariantTypeScreen extends StatelessWidget {
  const VariantTypeScreen({super.key});
  @override
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                         ...
                         children: [
                          const Text("Variant-Types",style: TextStyle(fontSize: 33,fontWeight: FontWeight.w700,color: Colors.black54),
                    ),
                    AddButton(context),
...
Widget AddButton(context){
  return ElevatedButton(
    onPressed: (){
     showVariantTypeAddform(context);
  },
